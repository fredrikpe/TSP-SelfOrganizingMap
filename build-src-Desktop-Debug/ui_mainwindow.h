...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        citiesCheckBox->setObjectName(QString::fromUtf8("citiesCheckBox"));

        verticalLayout_5->addWidget(citiesCheckBox);

        nodesCheckBox = new QCheckBox(groupBox_3);
        nodesCheckBox->setObjectName(QString::fromUtf8("nodesCheckBox"));

        verticalLayout_5->addWidget(nodesCheckBox);

        tourCheckBox = new QCheckBox(groupBox_3);
        tourCheckBox->setObjectName(QString::fromUtf8("tourCheckBox"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        groupBox_3->setTitle(QApplication::translate("MainWindow", "Display options", 0, QApplication::UnicodeUTF8));
        citiesCheckBox->setText(QApplication::translate("MainWindow", "Cities", 0, QApplication::UnicodeUTF8));
        nodesCheckBox->setText(QApplication::translate("MainWindow", "Nodes", 0, QApplication::UnicodeUTF8));
        tourCheckBox->setText(QApplication::translate("MainWindow", "Tour", 0, QApplication::UnicodeUTF8));
